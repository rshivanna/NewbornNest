...
interface PatientDialogProps {
  ...
  onSave: (patient: Omit<Patient, "id" | "createdAt" | "updatedAt" | "folderName" | "folderPath"> & { id?: string }) => void;
}
...
export const PatientDialog = ({
  ...
  useEffect(() => {
    if (patient) {
      ...
      // Baby details from nested object
      setBabyWeight(patient.babyDetails?.weightKg?.toString() || "");
      setBabySex(patient.babyDetails?.sex || "");
      ...
      // Maternal details from nested object
      ...
      setDeliveryMode(patient.maternalDetails?.deliveryMode || "");
      setGestationalAgeMethod(patient.maternalDetails?.gestationalAgeEstimationMethod || "");
    } else {
      setBabyName("");
      setMotherName("");
      setAddress("");
  ...
  const handleSave = () => {
    ...
    onSave({
      ...
      babyDetails: {
        ...
        weightKg: babyWeight ? parseFloat(babyWeight) : 0,
        sex: babySex || "",
        heartRateBpm: heartRate ? parseFloat(heartRate) : 0,
        temperatureC: temperature ? parseFloat(temperature) : 0,
      },
      maternalDetails: {
        maternalAgeYears: maternalAge ? parseInt(maternalAge) : 0,
        parity: parity.trim() || "",
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  id="babyName"
                  value={babyName}
                  onChange={(e) => setBabyName(toTitleCase(e.target.value))}
              ...
              <div className="grid gap-2">
                ...
                <Input
                  id="motherName"
                  value={motherName}
                  onChange={(e) => setMotherName(toTitleCase(e.target.value))}
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => setMaternalEducation(toTitleCase(e.target.value))}
